...
| P1-E01 | `BLOCKED` | GitHub CI [run #1](https://github.com/onitaiji4real/nook/actions/runs/29344526296) 五個 jobs 全部成功；rulesets 仍為 `[]`，尚未成為 required checks。   |
...
| P1-F04 | `BLOCKED` | `phase1@d038606` 已推送且 `main@dd5f146` 未變；rulesets 仍為 `[]`，尚缺 branch protection 與 reviewed PR evidence。                                     |
