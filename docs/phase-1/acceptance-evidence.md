...
| P1-B01 | `PASS`    | Terraform 1.15.8、Google provider 6.50.0 multi-platform lock；clean checkout 五個 validate、3 mocks、Trivy HIGH/CRITICAL 0。  |
...
| P1-F04 | `BLOCKED` | 六個實作/文件 commits 全在 `phase1`，未直接更新 main；尚缺 GitHub ruleset 與 `phase1` → `main` reviewed PR evidence。         |
