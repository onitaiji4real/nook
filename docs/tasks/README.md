...
| P4-001   | Consumer CRM consent boundary        | in_progress | P3-005                          |
| P4-002   | Verified completed reviews           | blocked     | P4-001                          |
| P4-003   | Public search & attribution          | blocked     | P4-002                          |
| P4-004   | Favorites & discovery return path    | blocked     | P4-003                          |
| P4-005   | Platform moderation console          | blocked     | P4-002、P4-003                  |
